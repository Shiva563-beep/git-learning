...
# as per requrinment line 8-12 resource group shiva-rg2 added
...
module "azurerm_resource_group3" {
  source              = "../Module/azurerm_resource_group"
  resource_group_name = "shiva-rg4"
  location            = "Japan East"
}
module "azurerm_resource_group4" {
  source              = "../Module/azurerm_resource_group"
  resource_group_name = "shiva-rg5"
  location            = "Japan East"
}
module "azurerm_resource_group5" {
  source              = "../Module/azurerm_resource_group"
